...
func (o *ClusterUninstaller) configureClients() error {
	...
	vnetClient, err := armnetwork.NewVirtualNetworksClient(subscriptionID, o.Session.TokenCreds, nil)
	if err != nil {
		return err
	}
	o.vnetClient = vnetClient

	subnetClient, err := armnetwork.NewSubnetsClient(subscriptionID, o.Session.TokenCreds, nil)
	if err != nil {
		return err
	}
