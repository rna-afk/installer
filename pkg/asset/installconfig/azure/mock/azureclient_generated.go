...
func (m *MockAPI) GetNatGateway(ctx context.Context, resourceGroupName, natGatewayName string) (*armnetwork.NatGateway, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNatGateway", ctx, resourceGroupName, natGatewayName)
...
func (mr *MockAPIMockRecorder) GetNatGateway(ctx, resourceGroupName, natGatewayName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNatGateway", reflect.TypeOf((*MockAPI)(nil).GetNatGateway), ctx, resourceGroupName, natGatewayName)
}

// GetRegionAvailabilityZones mocks base method.
func (m *MockAPI) GetRegionAvailabilityZones(ctx context.Context, region string) (bool, error) {
	m.ctrl.T.Helper()
