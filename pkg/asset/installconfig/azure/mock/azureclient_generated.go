...
// CheckSubnetNatgateway mocks base method.
func (m *MockAPI) CheckSubnetNatgateway(ctx context.Context, resourceGroup, virtualNetwork, subnet string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckSubnetNatgateway", ctx, resourceGroup, virtualNetwork, subnet)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CheckSubnetNatgateway indicates an expected call of CheckSubnetNatgateway.
func (mr *MockAPIMockRecorder) CheckSubnetNatgateway(ctx, resourceGroup, virtualNetwork, subnet any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckSubnetNatgateway", reflect.TypeOf((*MockAPI)(nil).CheckSubnetNatgateway), ctx, resourceGroup, virtualNetwork, subnet)
}
...
func (m *MockAPI) GetRegionAvailabilityZones(ctx context.Context, region string) (int, error) {
	m.ctrl.T.Helper()
