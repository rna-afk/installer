...
func NewDNSConfig(ssn *client.Session) *DNSConfig {
	return &DNSConfig{session: ssn}
}

func newZonesClient(session *client.Session) ZonesGetter {
...
func newRecordSetsClient(session *client.Session) *RecordSetsClient {
