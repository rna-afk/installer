...
import (
	...
	"github.com/openshift/installer/pkg/client/gcp"
...
func Validate(client gcp.API, ic *types.InstallConfig) error {
...
func ValidateInstanceType(client gcp.API, fieldPath *field.Path, project, zone, instanceType string, req resourceRequirements) field.ErrorList {
	allErrs := field.ErrorList{}
...
func validateInstanceTypes(client gcp.API, ic *types.InstallConfig) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidatePreExitingPublicDNS(client gcp.API, ic *types.InstallConfig) error {
...
func validateProject(client gcp.API, ic *types.InstallConfig, fieldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func validateNetworks(client gcp.API, ic *types.InstallConfig, fieldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func validateSubnet(client gcp.API, ic *types.InstallConfig, fieldPath *field.Path, subnets []*compute.Subnetwork, name string) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateEnabledServices(ctx context.Context, client gcp.API, project string) error {
