...
func MachineSets(clusterID string, config *types.InstallConfig, pool *types.MachinePool, osImage, role, userDataSecret string, capabilities map[string]string, useImageGallery bool, subnetZones int, session *icazure.Session) ([]*clusterapi.MachineSet, error) {
