...
func BootstrapIP(tfs *terraform.State) (string, error) {
	...
	publicIP, err := terraform.LookupResource(tfs, "module.bootstrap", "azurestack_public_ip", "bootstrap_public_ip")
	if err != nil {
		publicIP, err = terraform.LookupResource(tfs, "module.bootstrap", "azurestack_public_ip", "bootstrap_public_ip_v4")
	}
	if err != nil {
		publicIP, err = terraform.LookupResource(tfs, "module.bootstrap", "azurestack_public_ip", "bootstrap_public_ip_v6")
	}
	...
	br, err := terraform.LookupResource(tfs, "module.bootstrap", "azurestack_network_interface", "bootstrap")
	if err != nil {
...
func ControlPlaneIPs(tfs *terraform.State) ([]string, error) {
	mrs, err := terraform.LookupResource(tfs, "module.master", "azurestack_network_interface", "master")
	if err != nil {
