...
func TestValidatePlatform(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			expected: `^test-path\.outboundType: Unsupported value: "random-egress": supported values: "Loadbalancer", "NATGatewaySingleZone", "NATGatewayMultiZone", "UserDefinedRouting"$`,
		},
		{
