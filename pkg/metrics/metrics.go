...
func getNewDurationBuilder(metricName string, metricShortDesc string, initialBucketValue float64, maxBucketValue float64, stepSize float64) MetricBuilder {
...
func initializeDurationMetrics() {
	metricRegistry[ClusterInstallationDurationProvisioningJobName] =
		getNewDurationBuilder(ClusterInstallationDurationProvisioningJobName, "provisioning", 5, 60, 5)

	metricRegistry[ClusterInstallationDurationBootstrapJobName] =
		getNewDurationBuilder(ClusterInstallationDurationBootstrapJobName, "bootstrap", 5, 60, 5)

	metricRegistry[ClusterInstallationDurationOperatorsJobName] =
		getNewDurationBuilder(ClusterInstallationDurationOperatorsJobName, "operators", 5, 60, 5)

	metricRegistry[ClusterInstallationDurationInfrastructureJobName] =
		getNewDurationBuilder(ClusterInstallationDurationInfrastructureJobName, "infrastructure", 5, 60, 5)

	metricRegistry[ClusterInstallationDurationAPIJobName] =
		getNewDurationBuilder(ClusterInstallationDurationAPIJobName, "api", 5, 60, 5)
}
